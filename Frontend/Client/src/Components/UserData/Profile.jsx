...
    };
  ...
  return (
    <Box as="section" bg={useColorModeValue('gray.50', 'gray.700')} minH="100vh">
      <SidebarContent display={{ base: 'none', md: 'unset' }} handleNavItemClicked={handleNavItemClicked} handleSignOut={handleSignOut} navigate={navigate} />
      <Drawer isOpen={isOpen} onClose={onClose} placement="left">
        <DrawerOverlay />
        <DrawerContent bg={useColorModeValue('none')} w={60}>
          <SidebarContent borderRight="none" onClose={onClose} handleNavItemClicked={handleNavItemClicked} handleSignOut={handleSignOut} navigate={navigate} />
        </DrawerContent>
      </Drawer>
...
const SidebarContent = ({ handleNavItemClicked,handleSignOut,navigate, ...props }) => (
    ...
    <VStack h="full" w="full" alignItems="flex-start" justifyContent="space-between">
      <Box w="full">
        ...
        >
          ...
          <NavItem onClick={() =>navigate("/wishlist")} icon={Heart}>My Wishlist</NavItem>
          <NavItem onClick={() => navigate("/user_cart")} icon={ShoppingCart}>My Cart</NavItem>
          <NavItem onClick={() => navigate("/myOrders")} icon={myorder}>My Orders</NavItem>
          <NavItem onClick={() => navigate("/myOrders")} icon={TruckTick}>Track Order</NavItem>
